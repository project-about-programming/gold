...
constexpr Entry kEntries[] = {
    ...
    {L"header.sqlDemo", L"Database Demo", L"Демо на базе данных", L"Datenbank-Demo"},
    ...
    {L"nav.products", L"Inventory", L"Склад", L"Inventar"},
    {L"nav.clients", L"Customers", L"Клиенты", L"Kunden"},
    ...
    {L"page.sales.subtitle", L"Search, filter, and export sales transaction data.", L"Поиск, фильтрация и экспорт данных продаж.", L"Search, filter, and export sales transaction data."},
    ...
    {L"page.products.title", L"Inventory", L"Склад", L"Inventory"},
    {L"page.products.subtitle", L"Monitor stock, pricing, categories, and item availability.", L"Контроль остатков, цен, категорий и доступности товаров.", L"Monitor stock, pricing, categories, and item availability."},
    {L"page.clients.title", L"Customers", L"Клиенты", L"Customers"},
    {L"page.clients.subtitle", L"Review customer profiles, contact details, and purchase context.", L"Профили клиентов, контакты и история покупок.", L"Review customer profiles, contact details, and purchase context."},
